...
require "/home/vvasuki/scl/converters/convert.pl";
...
$pid = $ARGV[4];
      ...
      if($relation eq "tree"){
         ...
         system("/home/vvasuki/scl/amarakosha/get_all_rel.pl $word_wx $out_encoding > /tmp/AMARA_DOT/graph$pid.dot");
         ...
         my $str =  "/home/vvasuki/scl/amarakosha/relations.sh $dbm_fl_nm{$relation} '$headers{$relation}' $word_wx $out_encoding $pid";
         system($str);
      }
