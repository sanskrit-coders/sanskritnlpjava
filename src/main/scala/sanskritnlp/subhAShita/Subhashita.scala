...
case class TopicAnnotation(override val source: Source, topics: List[String]) extends Annotation(source)
case class MemorableBitsAnnotation(override val source: Source, memorableBits: List[String]) extends Annotation(source)
...
case class ScriptRendering(text: String, scheme: String,
